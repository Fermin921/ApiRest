...
request(app)
    ...
    .end((err, res) => {
        if (err) throw err;
        console.log('GET /usuarios debería devolver un json con los usuarios"');
    });
...
request(app)
    ...
    .end((err, res) => {
        if (err) throw err;
        console.log('GET /alumnos/{id} debería devolver un json con los datos del un usuario');
    });
...
request(app)
    ...
    .end((err, res) => {
        if (err) throw err;
        console.log('POST /insertar debería agregar un nuevo usuario');
    });
